...
<script type="module">
        ...
        window.login = function() {
            ...
            signInWithEmailAndPassword(auth, email, password)
                .then((userCredential) => {
                    ...
                    window.location.href = "product.php"; // Redirect after login
                })
                .catch((error) => {
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            const username = document.getElementById('username').value + '@example.com'; // Ensure this matches the register's email format
            const password = document.getElementById('password').value;
